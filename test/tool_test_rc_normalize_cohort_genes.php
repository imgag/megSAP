...
$name = "rc_normalize_cohort_genes";
...
check_exec("php ".src_folder()."/Tools/{$name}.php -ps_name Sample1 -in_cohort {$in_cohort1} -uncorrected_counts {$in_raw_counts1} -out_cohort {$out_cohort1} -out_sample {$out_sample1}");
