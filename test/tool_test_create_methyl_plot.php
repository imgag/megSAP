...
check_exec("php ".src_folder()."/Tools/".$name.".php -folder ".output_folder()." -name Testsample_01 -out ".output_folder().$name."_out1.tsv -regions ".data_folder().$name."_regions.tsv --log ".output_folder().$name."_1.log");
...
check_exec("php ".src_folder()."/Tools/".$name.".php -folder ".output_folder()." -name Testsample_02 -out ".output_folder().$name."_out2.tsv -regions ".data_folder().$name."_regions.tsv -skip_plot --log ".output_folder().$name."_2.log");
