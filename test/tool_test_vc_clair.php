...
$model1 = get_path("clair3_models")."/r1041_e82_400bps_hac_g632/";
check_exec("php ".src_folder()."/NGS/{$name}.php -bam ".data_folder().$name."_in3.bam -folder ".output_folder()." -target ".data_folder().$name."_in_roi.bed -name LSK114_02 -model {$model1} -threads 4 --log ".output_folder().$name."_out3.log");
