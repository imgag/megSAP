...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder().$name."_in2.vcf -out $out_file3 -genotype_mode multi --log ".output_folder().$name."_out3.log");
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder().$name."_in1.vcf -updown -out $out_file4 -genotype_mode skip --log ".output_folder().$name."_out4.log");
