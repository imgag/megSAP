...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.vcf -updown -out $out_file2 -genotype_mode skip --log ".output_folder().$name."_out2.log -test");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in_db2.vcf -out $out_file_db --log ".output_folder().$name."_out_db2.log -test");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in_empty.vcf -out $out_file_empty --log ".output_folder().$name."_out_empty.log -test");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in_dragen.vcf -out $out_file_dragen --log ".output_folder().$name."_out_dragen.log -test");
...
if (is_array($custom_columns_test))
{
	...
	check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in_dragen2.vcf -out $out_file_dragen2 --log ".output_folder().$name."_out_dragen2.log -custom custom_columns_test -test");
