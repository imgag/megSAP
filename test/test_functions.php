...
check(allele_count(data_folder()."/allele_count_in.bam","chr5",142421388),array("C"=>552, "T"=>358, "A"=>1, "G"=>0, "*"=>0));
check(allele_count(data_folder()."/allele_count_in.bam","chr13",110436093),array("C"=>0, "T"=>0, "A"=>320, "G"=>42, "*"=>1)); 
check(allele_count(data_folder()."/allele_count_in.bam","chr19",1221301),array("C"=>210, "T"=>0, "A"=>0, "G"=>4, "*"=>3)); 
end_test();
//##################################################################################
