...
$log = output_folder() . "an_filter_dragen_somatic_out1.log";
$target = data_folder() . "an_filter_dragen_somatic_target1.bed"; 
check_exec("php ".src_folder()."/Tools/an_filter_dragen_somatic.php -in $vcf -tumor_name $tumor_name -normal_name $normal_name -out $out -target $target --log $log");
