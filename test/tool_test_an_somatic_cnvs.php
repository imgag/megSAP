...
check_exec("php ".src_folder()."/Tools/an_somatic_cnvs.php -cnv_in $cnv_input_1  -include_ncg -out $cnv_output_1 ");
...
check_exec("php ".src_folder()."/Tools/an_somatic_cnvs.php -cnv_in $cnv_input_2 -rna_counts $rna_counts -out $cnv_output_2 -rna_id RX01_01 -rna_ref_tissue colon");
...
check_exec("php ".src_folder()."/Tools/an_somatic_cnvs.php -cnv_in $cnv_input_3 -rna_counts $rna_counts -out $cnv_output_3 -rna_id RX01_01");
...
check_exec("php ".src_folder()."/Tools/an_somatic_cnvs.php -cnv_in $cnv_input_4 -out $cnv_output_4 -include_cytoband");
