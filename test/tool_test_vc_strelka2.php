...
check_exec("php ".src_folder()."/NGS/vc_strelka2.php -t_bam $t_bam -n_bam $n_bam -out $out_file -keep_lq -smallIndels ".data_folder()."/vc_strelka2_smallIndels_in.vcf.gz --log ".output_folder().$name."_1.log");
...
check_exec("php ".src_folder()."/NGS/vc_strelka2.php -t_bam $t_bam -n_bam $n_bam -out $out_file -keep_lq -target ".data_folder()."/vc_strelka2.bed -smallIndels ".data_folder()."/vc_strelka2_smallIndels_in.vcf.gz --log ".output_folder().$name."_3.log");
