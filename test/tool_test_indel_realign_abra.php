...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -roi ".data_folder().$name."_roi.bed -out $out_file1 --log ".output_folder().$name."_out1.log");
check_file($out_file1, data_folder().$name."_out1.bam");

//test without ROI
$out_file2 = output_folder().$name."_out2.bam";
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -out $out_file2 --log ".output_folder().$name."_out2.log");
