...
check_exec("php ".src_folder()."/NGS/vc_strelka.php -t_bam $t_bam -n_bam $n_bam -out $out_file -amplicon --log ".output_folder().$name."_1.log");
check_file($out_file, data_folder().$name."_out.vcf.gz");

$out_file2 = output_folder().$name."_out2.vcf.gz";
check_exec("php ".src_folder()."/NGS/vc_strelka.php -t_bam $t_bam -n_bam $n_bam -out $out_file2 -r -amplicon --log ".output_folder().$name."_2.log");
