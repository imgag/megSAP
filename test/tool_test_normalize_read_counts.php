...
check_exec("php ".src_folder()."/NGS/{$name}.php -in '$in_file' -out '$out_file1' -method rpkm --log $log_file1");
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in '$in_file' -out '$out_file2' -method cpm --log $log_file2");
