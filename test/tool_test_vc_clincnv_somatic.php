...
$t_cov = "{$cov_folder_t}/DX000007_01.cov";
$n_cov = "{$cov_folder_n}/DX000007_02.cov";
...
$t_cov_off = $cov_folder_t_off . "DX000007_01.cov";
$n_cov_off = $cov_folder_n_off . "DX000007_02.cov";

check_exec("php ".src_folder()."/NGS/{$name}.php -t_id DX000007_01 -n_id DX000007_02 -cov_folder_n $cov_folder_n -cov_folder_t $cov_folder_t -cohort_folder $cohort_folder2 -cov_pairs $t_n_pair_file -out $out_file -t_cov $t_cov -n_cov $n_cov -bed $bed_file -system $system_file -t_cov_off $t_cov_off -n_cov_off $n_cov_off -cov_folder_n_off $cov_folder_n_off -cov_folder_t_off $cov_folder_t_off -bed_off $bed_file_off -baf_folder $baf_folder");
