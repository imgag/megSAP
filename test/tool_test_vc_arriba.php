...
check_exec("php ".src_folder()."/NGS/{$name}.php -bam $in_bam -out_fusions $out_tsv -out_discarded $out_discarded -out_vcf $out_vcf -out_pdf $out_pdf -out_pic_dir $out_pic_dir --log ".output_folder().$name."_out1.log");
