...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder().$name."_in1.bam -vcf ".data_folder().$name."_in1.vcf -out $out_file5 -type WES -target ".data_folder().$name."_in_genes_ext_merged.bed --log ".output_folder().$name."_out1.log");
