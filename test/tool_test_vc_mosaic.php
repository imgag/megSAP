...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -out $out_file1 -min_obs 2 -target ".data_folder().$name."_in_genes_ext_merged.bed --log ".output_folder().$name."_out1.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -out $out_file2 -min_obs 3 -no_zip -target ".data_folder().$name."_in_genes_ext_merged.bed --log ".output_folder().$name."_out2.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -out $out_file3 -min_obs 2 -target ".data_folder().$name."_in_genes_ext_merged.bed -threads 2 --log ".output_folder().$name."_out3.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".data_folder().$name."_in1.bam -out $out_file4 -min_obs 2 -target ".data_folder().$name."_in_genes_ext_merged.bed  -threads 4 --log ".output_folder().$name."_out4.log");
