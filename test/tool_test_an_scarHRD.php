...
check_exec("php ".src_folder()."/Tools/{$name}.php -cnvs ".data_folder()."/{$name}_in1.tsv -tumor DNA220001_01 -normal DNA220002_01 -out_folder ".output_folder()."/ -db NGSD_TEST --log $log_file");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -cnvs ".data_folder()."/{$name}_in2.tsv -tumor DNA220003_01 -normal DNA220004_01 -out_folder ".output_folder()."/ -db NGSD_TEST -filtered --log $log_file");
