...
# single-threaded
check_exec("php ".src_folder()."/NGS/{$name}.php -gvcfs ".implode(" ", $inputs)." -out ".output_folder().$name."_out1.vcf.gz -status affected control control -threads 1 -mode longread --log ".output_folder().$name."_out1.log");
...
# multi-threaded
check_exec("php ".src_folder()."/NGS/{$name}.php -gvcfs ".implode(" ", $inputs)." -out ".output_folder().$name."_out2.vcf.gz -status affected control control -threads 4 -mode longread --log ".output_folder().$name."_out2.log");
