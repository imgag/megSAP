...
check_exec("php ".src_folder()."/NGS/filter_vcf.php -in ".data_folder().$name."_in2.vcf -out $out_file2 -keep -type coding,non_synonymous,somatic,off_target -contamination 0.03 -roi ../data/enrichment/ssHAEv5_2016_07_11.bed");
...
check_exec("php ".src_folder()."/NGS/filter_vcf.php -in ".data_folder().$name."_in4.vcf -out $out_file4 -type coding,non_synonymous,somatic,off_target -roi ../data/enrichment/SeqCapEZv2_2013_02_19.bed");
check_file($out_file4, data_folder().$name."_out4.vcf");

$out_file5 = output_folder().$name."_out5.vcf";
check_exec("php ".src_folder()."/NGS/filter_vcf.php -in ".data_folder().$name."_in5.vcf -out $out_file5 -type coding,somatic_capa,off_target -keep -roi ../data/enrichment/SeqCapEZv2_2013_02_19.bed");
