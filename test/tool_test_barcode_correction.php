...
check_exec(execApptainer("umiVar", "barcode_correction.py", "--infile ".data_folder().$name."_in1.bam --outfile $out_file1 --barcode_error 1 --minBQ 30", [data_folder()], [output_folder()], true));
