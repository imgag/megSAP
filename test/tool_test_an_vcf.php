...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in1.vcf -out $out_file1 --log ".output_folder().$name."_out1.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in2.vcf.gz -out $out_file2 --log ".output_folder().$name."_out2.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in_empty.vcf -out $out_file_empty --log ".output_folder().$name."_out_empty.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in3.vcf -out $out_file3 --log ".output_folder().$name."_out3.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in_dragen.vcf -out $out_file_dragen --log ".output_folder().$name."_out_dragen.log -annotate_refseq_consequences");
...
if (is_array($custom_columns_test))
{
	...
	check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in_dragen.vcf -out $out_file_dragen2 --log ".output_folder().$name."_out_dragen2.log -custom custom_columns_test");
	remove_lines_containing($out_file_dragen2, array("##INFO=<ID=NGSD_GENE_INFO,"));
...
if (db_is_enabled("NGSD")) 
{
	...
	check_exec("php ".src_folder()."/Tools/{$name}.php -test -ps_name NA12878_03 -in ".data_folder().$name."_in1.vcf -out $out_file_db1 --log ".output_folder().$name."_out_db1.log");
	...
	check_exec("php ".src_folder()."/Tools/{$name}.php -test -somatic -in ".data_folder().$name."_in1.vcf -out $out_file_som --log ".output_folder().$name."_out_som.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -test -in ".data_folder().$name."_in5_som_vicc.vcf -out $out_file_som_vicc -somatic --log ".output_folder().$name."_out_som_vicc.log");
remove_lines_containing($out_file_som_vicc, array("##INFO=<ID=NGSD_GENE_INFO,", "##INFO=<ID=NGSD_GROUP"));
