...
if (db_is_enabled("NGSD")) 
{
	...
	check_exec("cd ".output_folder()."190228_NB501582_0169_AH5LG5BDXX_00001/ && php ".src_folder()."/IMGAG/{$name}.php -test -samplesheet {$name}_in1.csv -out {$out_file} -db NGSD_TEST -runinfo {$runinfo}");
	...
	check_exec("cd ".output_folder()."190228_NB501582_0169_AH5LG5BDXX_00001/ && php ".src_folder()."/IMGAG/{$name}.php -test -samplesheet {$name}_in2.csv -out {$out_file} -db NGSD_TEST -runinfo {$runinfo}");
	...
	check_exec("cd ".output_folder()."190228_NB501582_0169_AH5LG5BDXX_01489/ && php ".src_folder()."/IMGAG/{$name}.php -test -samplesheet {$name}_in3.csv -out {$out_file} -db NGSD_TEST -runinfo {$runinfo}");
	...
	check_exec("cd ".output_folder()."20230823_LH00240_0003_AFCID0001_00123/ && php ".src_folder()."/IMGAG/{$name}.php -test -out {$out_file} -db NGSD_TEST");
