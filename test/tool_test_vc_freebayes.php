...
check_exec("php ".src_folder()."/Tools/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file1 -target ".data_folder().$name."_in.bed --log ".output_folder().$name."_out1.log");
...
for ($i=2; $i<=4; ++$i)
{
	...
	check_exec("php ".src_folder()."/Tools/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file2 -target ".data_folder().$name."_in.bed -threads {$i} --log ".output_folder().$name."_out2_{$i}threads.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file3 -target ".data_folder().$name."_in.bed -target_extend 50 --log ".output_folder().$name."_out3.log");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file4 --log ".output_folder().$name."_out4.log -min_af 0.10");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file5 -target ".data_folder().$name."_in.bed -raw_output --log ".output_folder().$name."_out5.log");
