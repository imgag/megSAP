...
check_exec("php ".src_folder()."/NGS/{$name}.php -bam ".data_folder().$name."_in.bam -out $out_file5 -target ".data_folder().$name."_in.bed -raw_output --log ".output_folder().$name."_out5.log");
