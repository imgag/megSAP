...
exec("rm -rf ".output_folder()."230823_LH00240_0003_AFCID0001_00123");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".output_folder()."230823_LH00240_0003_AFCID0001_00123 -out_folder ".output_folder()."backup -test --log ".output_folder()."test1.log", FALSE);

//test 2 - remove 2nd analysis folder  backup NovaSeqX run 
exec("rm -d ".output_folder()."230823_LH00240_0003_AFCID0001_00123/Analysis/2");
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".output_folder()."230823_LH00240_0003_AFCID0001_00123 -out_folder ".output_folder()."backup -test --log ".output_folder()."test2.log", TRUE);
check_exec("tar xzf ".output_folder()."backup/230823_LH00240_0003_AFCID0001_00123.tar.gz -C ".output_folder()."restore/");
//check files
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/BCLConvert/fastq/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/BCLConvert/fastq/";
...
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenEnrichment/ora_fastq/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenEnrichment/ora_fastq/";
...
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenEnrichment/fastq/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenEnrichment/fastq/";
...
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenGermline/DX180049_05/germline_seq/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Analysis/3/Data/DragenGermline/DX180049_05/germline_seq/";
...
exec("rm -r ".output_folder()."restore/230823_LH00240_0003_AFCID0001_00123");
exec("cp ".data_folder().$name."_in_runparameters1.xml ".output_folder()."230823_LH00240_0003_AFCID0001_00123/RunParameters.xml"); //replace RunParameters.xml
check_exec("php ".src_folder()."/Tools/{$name}.php -in ".output_folder()."230823_LH00240_0003_AFCID0001_00123 -out_folder ".output_folder()."backup -test --log ".output_folder()."test2.log", TRUE);
check_exec("tar xzf ".output_folder()."backup/230823_LH00240_0003_AFCID0001_00123.tar.gz -C ".output_folder()."restore/");

//check files
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Data/Intensities/BaseCalls/L001/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Data/Intensities/BaseCalls/L001/";
...
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Thumbnail_Images/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Thumbnail_Images/";
check(file_exists("{$restored_folder}pic1.png"), false);
check(file_exists("{$restored_folder}pic2.png"), false);
check(file_exists("{$restored_folder}pic3.png"), false);
$ref_folder = output_folder()."230823_LH00240_0003_AFCID0001_00123/Unaligned/";
$restored_folder = output_folder()."restore/230823_LH00240_0003_AFCID0001_00123/Unaligned/";
