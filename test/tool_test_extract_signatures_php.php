...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder()."/extract_signatures_in0.vcf -mode snv -reference GRCh38 -threads 4 -out $out -seeds $seeds -nmfRep 10 --log ".output_folder().$name."_out0.log");
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder()."/extract_signatures_in3.vcf -mode snv -reference GRCh38 -threads 4 -out $out -seeds $seeds -nmfRep 10 --log ".output_folder().$name."_out1.log");

//cnvs
$out = output_folder()."{$name}_out2/";
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder()."/extract_signatures_clincnv_in1.tsv -mode cnv -reference GRCh38 -threads 4 -out $out -seeds $seeds -nmfRep 10 --log ".output_folder().$name."_out2.log");
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder()."/extract_signatures_clincnv_in2.tsv -mode cnv -reference GRCh38 -threads 4 -out $out -seeds $seeds -nmfRep 10 --log ".output_folder().$name."_out3.log");
