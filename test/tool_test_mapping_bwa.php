...
$in_sheet = data_folder().$name."_in_sheet.csv";
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in1 '$in1_file' -in2 '$in2_file' -out '$out_file1' --log $log_file1 -sheet $in_sheet -threads 1");
...
check_exec("php ".src_folder()."/NGS/{$name}.php -in1 '$in1_file' -in2 '$in2_file' -out '$out_file2' --log $log_file2 -sheet $in_sheet -dedup -threads 1");
