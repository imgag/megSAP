...
check_exec("php ".src_folder()."/Tools/{$name}.php -in1 '$in1_file' -in2 '$in2_file' -out '$out_file1' --log $log_file1 -threads 1");
...
check_exec("php ".src_folder()."/Tools/{$name}.php -in1 '$in1_file' -in2 '$in2_file' -out '$out_file2' --log $log_file2 -dedup -threads 1");
