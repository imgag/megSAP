...
check_exec("php ".src_folder()."/NGS/{$name}.php -bam ".implode(" ", $input_files)." -sample_ids 21073LRa015 21073LRa013 21073LRa014 -out $out_file2 -threads 2 --log ".output_folder().$name."_out2.log");
