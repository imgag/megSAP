...
check_exec("php ".src_folder()."/NGS/{$name}.php -in ".data_folder().$name."_in1.vcf -out $out_file1 -t_col GS110168 -n_col GS110169 -db NGSD_TEST --log ".output_folder().$name."_out1.log");
