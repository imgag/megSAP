...
#download manta
cd $folder
wget https://github.com/Illumina/manta/releases/download/v1.2.2/manta-1.2.2.centos6_x86_64.tar.bz2
tar xjf manta-1.2.2.centos6_x86_64.tar.bz2
rm manta-1.2.2.centos6_x86_64.tar.bz2
cd manta-1.2.2.centos6_x86_64
