...
cd ngs-bits
git checkout 2024_07 && git submodule update --recursive --init
make build_3rdparty
...
cd $folder
$folder/Python-3.10.9/bin/python3 -m venv Python-3.10.9_19.08.24
source $folder/Python-3.10.9_19.08.24/bin/activate
...
chmod -R 777 $folder/Python-3.10.9_19.08.24/lib/python3.10/site-packages/SigProfiler*
$folder/Python-3.10.9_19.08.24/bin/python3 $root/../src/NGS/extract_signatures.py --installGenome --reference GRCh38 --in . --outFolder .
