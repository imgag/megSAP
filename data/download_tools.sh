...
cd Python-3.10.9
./configure --prefix=$folder/Python-3.10.9 --enable-optimizations --enable-loadable-sqlite-extensions
make
make install

# create common python venv for megSAP
cd $folder
$folder/Python-3.10.9/bin/python3 -m venv Python-3.10.9_2024.11.06
source $folder/Python-3.10.9_2024.11.06/bin/activate
...
chmod -R 777 $folder/Python-3.10.9_2024.11.06/lib/python3.10/site-packages/SigProfiler*
$folder/Python-3.10.9_2024.11.06/bin/python3 $root/../src/NGS/extract_signatures.py --installGenome --reference GRCh38 --in . --outFolder .
