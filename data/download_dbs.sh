...
(grep ^"#" Homo_sapiens.GRCh38.112_original.gtf; grep -v ^"#" Homo_sapiens.GRCh38.112_original.gtf | sort -k1,1 -k4,4n | sed -e 's/^/chr/') | singularity exec $htslib bgzip  > Homo_sapiens.GRCh38.112.gtf.gz
singularity exec $htslib tabix -p gff Homo_sapiens.GRCh38.112.gtf.gz
