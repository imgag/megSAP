...
cat hg38.fa.out | php $src/Tools/db_converter_repeatmasker.php | $ngsbits/BedSort | bgzip > RepeatMasker.bed.gz
...
tabix -p vcf clinvar_20210110_converted_GRCh38.vcf.gz
#CNVs
