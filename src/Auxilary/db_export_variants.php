...
$parser = new ToolBase("db_export_variants", "Exports variants for a set of samples and genes from NGSD.");
...
if ($anno && $gsvar)
{
	...
	$parser->execTool("Tools/vcf2gsvar.php", "-in {$vcf_anno} -out {$gsvar}");
}
?>