...
$parser->addString("sample", "Processed sample.", false);
$parser->addStringArray("test", "Processed sample names of samples to test against.", false);
$parser->addFloat("max_af", "Maximum AF of variants to use for comparison in gnomAD", true, 0.02);
