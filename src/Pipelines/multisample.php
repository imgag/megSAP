...
$hgmd_file = "{$data_folder}/dbs/HGMD/HGMD_CNVS_2021_1.bed";
...
if (in_array("cn", $steps))
{
	...
	if(!$skip_cn)
	{
		...
		$parser->exec("{$ngsbits}BedAnnotateFromBed", "-in {$cnv_multi} -in2 {$data_folder}/dbs/ClinVar/clinvar_cnvs_2021-04.bed -name clinvar_cnvs -url_decode -no_duplicates -out {$cnv_multi}", true);
