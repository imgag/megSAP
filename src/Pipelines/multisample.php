...
if (in_array("cn", $steps))
{
	...
	if(!$skip_cn)
	{
		...
		$parser->exec("{$ngsbits}BedAnnotateFromBed", "-in {$cnv_multi} -in2 {$data_folder}/dbs/ClinVar/clinvar_cnvs_2021-12.bed -name clinvar_cnvs -url_decode -no_duplicates -out {$cnv_multi}", true);
