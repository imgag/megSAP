...
if(in_array("cn",$steps))
{
	...
	if($single_sample) //use CNVHunter in case of single samples
	{
		...
		$parser->exec(get_path("ngs-bits")."BedAnnotateFromBed", "-in {$som_cnv} -in2 {$data_folder}/dbs/ClinGen/dosage_sensitive_disease_genes_GRCh38.bed -no_duplicates -url_decode -out {$som_cnv}", true);
