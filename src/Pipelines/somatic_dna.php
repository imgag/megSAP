...
//			if($amplicon)	$extra .= " -amplicon";
	...
	if (in_array("vc", $steps))
	{
		...
		$parser->execTool("NGS/vc_cnvhunter.php", "-cov $t_cov -out $som_cnv -system $t_sys -min_reg 3 -min_corr 0");
	}
...
//			if($amplicon)	$extra .= " -amplicon";
	...
	{			
		...
		$parser->execTool("NGS/vc_cnvhunter.php", "-cov $t_cov -n_cov $n_cov -out $som_cnv -system $t_sys -min_reg 3 -min_corr 0");
	}
