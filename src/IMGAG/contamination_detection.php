...
$parser->execApptainer("ngs-bits", "VcfFilter", "-qual $min_var_qual -sample 'DP >= $min_var_depth' -info 'MQM >= $min_var_mapq' -in $ann_vcf -out $filtered_vcf -ref ".genome_fasta("GRCh38"), [$ann_vcf, genome_fasta("GRCh38")]);

//convert to GSvar
$gsvar = $parser->tempFile(".GSvar");
$parser->execTool("Tools/vcf2gsvar.php", "-in $filtered_vcf -out $gsvar");
