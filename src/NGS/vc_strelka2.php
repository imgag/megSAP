...
//parse Strelka SNV output
//collect comments
$comments = array_unique(array_merge($strelka_snvs->getComments(),
	$strelka_indels->getComments(),
	[ "#PEDIGREE=<Tumor={$t_ps},Normal={$n_ps}>" ]));
...
$colnames[$colidx_tumor] = $t_ps;
$colnames[$colidx_normal] = $n_ps;
