...
{	
	...
	$parser->exec(get_path("ngs-bits")."BedAdd", "-in {$repository_basedir}/data/misc/af_genomes_imgag_GRCh37.bed {$repository_basedir}/data/misc/centromer_telomer.bed -out {$poly_merged}", true);
