...
$parser = new ToolBase("vc_pindel", "\$Rev: 712 $", "Run pindel. No Haloplex.");
...
//annotate genes
//$region_file = $out."/_regions.bed";
//$parser->exec(get_path("ngs-bits")."GenesToBed", " -in $genes -out $region_file -mode gene", true);
