...
#    with open(FILE) if magic_number!='\x1f\x8b' else bgzf.open(FILE) as f1:
        with open(bc_file1) if magic_number!='\x1f\x8b' else gzip.open(bc_file1) as f2, open(bc_file2) if magic_number!='\x1f\x8b' else gzip.open(bc_file2) as f3:
#        with open(bc_file1) if magic_number!='\x1f\x8b' else bgzf.open(bc_file1) as f2, open(bc_file2) if magic_number!='\x1f\x8b' else bgzf.open(bc_file2) as f3:
                for (c1, c2, c3) in izip(f1, f2, f3):
                    ...
                    if line1.startswith('@') and line2.startswith('@') and line3.startswith('@') and L==1:
                        ...
                        LINE_1 = READ_NAME + ":" + str(BARCODE1_l) + "," + str(BARCODE2_l) + ":" + BARCODE1 + "," + BARCODE2 + "\n"
                        #print READ_NAME + ":" + str(BARCODE_l) + "," + str(0) + ":" + BARCODE + "," + "."
...
#        with open(bc_file1) if magic_number!='\x1f\x8b' else bgzf.open(bc_file1) as f2:
...
#    with open(FILE) if magic_number!='\x1f\x8b' else bgzf.open(FILE) as f1:
 ...
 #       with open(bc_file2) if magic_number!='\x1f\x8b' else bgzf.open(bc_file2) as f3:
