...
fwrite($config_file, annotation_file_path("/dbs/ClinVar/clinvar_20220702_converted_GRCh38.vcf.gz")."\tCLINVAR\tDETAILS\tID\n");

// add HGMD annotation
$hgmd_file = annotation_file_path("/dbs/HGMD/HGMD_PRO_2022_2_fixed.vcf.gz", true); //HGMD annotation (optional because of license)
