...
$parser->addEnum("mode", "Select mode to determine varaints which are used for comparison.", true, array("AF_outliers_from_GSvar", "AF_outlier_calling"), "AF_outliers_from_GSvar");
...
$parser->addInt("min_var_qual", "[mode: AF_outlier_calling] Minimum quality value for variants. (default: 30)", true,  30);
$parser->addInt("min_var_depth", "[mode: AF_outlier_calling] Minimum depth for variants. (default: 50)", true, 50);
$parser->addInt("min_var_mapq", "[mode: AF_outlier_calling] Minimum mapping quality for variants. (default: 55)", true, 55);
$parser->addFloat("max_gnomad_af", "[mode: AF_outlier_calling] Maximum gnomAD allele frequency. (default: 0.3)", true, 0.3);
$parser->addInfile("ann_vcf", "[mode: AF_outlier_calling] Annotated VCF with varaints which should be used for comparison (generated by a previous run).", true);
