...
def parse_args():
    ...
    parser.add_argument("--hp2_file", type=str, help="modkit file containing the sample's methylation of the second allele.", required=True)
    parser.add_argument("--hp1_cohort_files", nargs='+', type=str, help="modkit files containing the cohort's methylation of the first allele.", required=True)
    parser.add_argument("--hp2_cohort_files", nargs='+', type=str, help="modkit files containing the cohort's methylation of the second allele.", required=True)
