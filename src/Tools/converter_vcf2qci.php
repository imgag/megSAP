...
$parser->exec(get_path("ngs-bits")."VcfLeftNormalize"," -in $vcf_qci -out $vcf_qci_aligned -comp 0 -ref ".genome_fasta($build), true);
...
$parser->exec(get_path("ngs-bits")."VcfSort","-in $vcf_qci_aligned -out $vcf_qci_sorted -comp 0", true);
