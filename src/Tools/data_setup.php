...
if ($build=="GRCh38")
{
	...
	if ($copy_vep_dbs_to_local_data==true || $copy_vep_dbs_to_local_data=="true")
	{
		...
		$db_files = array("/dbs/CADD/CADD_SNVs_1.6_GRCh38.vcf.gz", "/dbs/CADD/CADD_InDels_1.6_GRCh38.vcf.gz", "/dbs/REVEL/revel_grch38_all_chromosomes.tsv.gz", "/dbs/dbscSNV/dbscSNV1.1_GRCh38.vcf.gz", "/dbs/gnomAD/gnomAD_genome_v3.1.1_GRCh38.vcf.gz", "/dbs/gnomAD/gnomAD_genome_v3.1.mito_GRCh38.vcf.gz", "/dbs/RepeatMasker/RepeatMasker_GRCh38.bed", "/dbs/ClinVar/clinvar_20211212_converted_GRCh38.vcf.gz", "/dbs/phyloP/hg38.phyloP100way.bw", "/dbs/SpliceAI/spliceai_scores_2021_06_11_GRCh38.vcf.gz", "/dbs/MMSplice/mmsplice_scores_2021_06_11_GRCh38.vcf.gz");
