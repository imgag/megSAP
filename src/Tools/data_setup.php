...
if ($build=="GRCh37")
{
	...
	if ($copy_vep_dbs_to_local_data==true || $copy_vep_dbs_to_local_data=="true")
	{
		...
		$db_files = array("/dbs/CADD/CADD_SNVs_1.6.vcf.gz", "/dbs/CADD/CADD_InDels_1.6.vcf.gz", "/dbs/REVEL/revel_all_chromosomes.tsv.gz", "/dbs/fathmm-MKL/fathmm-MKL_Current.tab.gz", "/dbs/dbscSNV/dbscSNV1.1_GRCh37.txt.gz", "/dbs/gnomAD/gnomAD_genome_r2.1.1.vcf.gz", "/dbs/RepeatMasker/RepeatMasker.bed.gz", "/dbs/ClinVar/clinvar_20200506_converted.vcf.gz", "/dbs/phyloP/hg19.100way.phyloP100way.bw", "/dbs/SpliceAI/spliceai_scores.ngsd.13.12.20.vcf.gz");
