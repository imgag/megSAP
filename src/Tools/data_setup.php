...
if ($build=="GRCh37")
{
	...
	if ($copy_vep_dbs_to_local_data==true || $copy_vep_dbs_to_local_data=="true")
	{
		...
		$db_files = array("/dbs/CADD/CADD_SNVs_1.6.vcf.gz", "/dbs/CADD/CADD_InDels_1.6.vcf.gz", "/dbs/REVEL/revel_all_chromosomes.tsv.gz", "/dbs/fathmm-MKL/fathmm-MKL_Current.tab.gz", "/dbs/dbscSNV/dbscSNV1.1_GRCh37.txt.gz", "/dbs/gnomAD/gnomAD_genome_r2.1.1.vcf.gz", "/dbs/RepeatMasker/RepeatMasker.bed.gz", "/dbs/ClinVar/clinvar_20210110_converted.vcf.gz", "/dbs/phyloP/hg19.100way.phyloP100way.bw", "/dbs/SpliceAI/spliceai_scores_2021_02_03.vcf.gz", "/dbs/MMSplice/mmsplice_scores_2021_02_03.vcf.gz", "/dbs/UCSC/hg19_genomicSuperDups.bed.gz", "/dbs/UCSC/hg19_simpleRepeat.bed.gz", "/dbs/gnomAD/gnomAD_OE_sorted.bed.gz", "/dbs/ABB/hg19_ABB-SCORE.bed.gz", "/dbs/phastCons/hg19_phastCons46way_mammal.bw", "/dbs/phastCons/hg19_phastCons46way_primate.bw", "/dbs/phastCons/hg19_phastCons46way_vertebrate.bw", "/dbs/phyloP/hg19_phyloP46way_mammal.bw", "/dbs/phyloP/hg19_phyloP46way_primate.bw", "/dbs/phyloP/hg19_phyloP46way_vertebrate.bw", "/dbs/Condel/hg19_precomputed_Condel.vcf.gz", "/dbs/Eigen/hg19_Eigen-phred_coding_chrom1-22.vcf.gz", "/dbs/fathmm-XF/hg19_fathmm_xf_coding.vcf.gz", "/dbs/MutationAssessor/hg19_precomputed_MutationAssessor.vcf.gz", "/dbs/CAPICE/capice_v1_grch37_snvs.vcf.gz");
