...
* `use_deepvariant` - Flag (true/false) that indicates if DeepVariant should be used instead of freebayes for variant calling (DeepVariant is slower, but shows better performance, see [here](performance.md)).
