...
|gnomAD (genome)        |pipeline                |03.2023 (3.1.2)                 |version 4.0 available, wait for 4.1 before updating                                                 |http://gnomad.broadinstitute.org/downloads                              |
...
|HGMD (SNVs and CNVs)   |pipeline                |11.2023 (2023.3)                |update IGV custom tacks in GSvar                                                                    |https://apps.ingenuity.com/ingsso/login                                 |
|Ensembl                |NGSDImportEnsembl       |03.2023 (GRCh38.109)            |update IGV genome                                                                                   |https://ftp.ensembl.org/pub/release-109/gff3/homo_sapiens/              |
|HPO                    |NGSDImportHPO           |03.2023 (latest - not versioned)|send updated HPO list to Anne (/mnt/storage2/users/ahsturm1/Sandbox/2021_10_21_hpo_update/)         |https://hpo.jax.org/app/                                                |
